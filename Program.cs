...
namespace DebuggingAndErrorHandlingExercise2
{
    class Program
    {
        ...
        {
            Console.WriteLine("Stegosaurus is a genus of armored dinosaur. Fossils of this genus date to the Late Jurassic period, where they are found in Kimmeridgian to early Tithonian aged strata, between 155 and 150 million years ago, in the western United States and Portugal.Source: Wikipedia.");
        }

        static void DisplayVelociraptorInfo()
        {
            Console.WriteLine("Velociraptor, meaning \"swift seizer\" in Latin, is a genus of dromaeosaurid theropod dinosaur that lived approximately 75 to 71 million years ago during the later part of the Cretaceous Period.Two species are currently recognized, although others have been assigned in the past.Source: Wikipedia.");
        }
    }
}